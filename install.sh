...
download_file "skills/create-plan/references/plan-template.md" "$CONFIG_DIR/skills/create-plan/references/plan-template.md"
download_file "skills/create-plan/references/task-template.md" "$CONFIG_DIR/skills/create-plan/references/task-template.md"
...
download_file "skills/retro-man/references/contract-template.md" "$CONFIG_DIR/skills/retro-man/references/contract-template.md"
download_file "skills/retro-man/references/index-format.md" "$CONFIG_DIR/skills/retro-man/references/index-format.md"
...
echo "- skills/create-plan/references/plan-template.md"
echo "- skills/create-plan/references/task-template.md"
echo "- skills/grill-design/SKILL.md"
echo "- skills/guideline/SKILL.md"
echo "- skills/retro-man/SKILL.md"
echo "- skills/retro-man/references/contract-template.md"
echo "- skills/retro-man/references/index-format.md"
